                    ...
                    <div class="grid-100">
                            ...
                            <nav id="main-nav">
                                <ul>
                                    ...
                                    <li class="man-nav-option"><?php echo anchor(lang('url_contacto'), lang('contacto')) ?></li>
                                </ul>
                            </nav>
                            <div class="clear"></div>
                        </div>
    ...
    <div class="odd wrapper">
          <div class="grid-container">
                   ...
                   <div class="grid-100">
                     ...
                     <div class="grid-50">               <?php echo empty($espectaculo_data['cid_descripcion'])?$espectaculo_data['cid_descripcion_corta']:$espectaculo_data['cid_descripcion']; ?></div>
