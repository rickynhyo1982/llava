    ...
    <body>
        <div>
                    ...
                    <div class="grid-100">
                            ...
                            <nav id="main-nav">
                                <ul>
                                    ...
                                    <li class="man-nav-option current" ><?php echo anchor('inicio#programacion', 'Programación') ?></li>
                                    <li class="man-nav-option"><?php echo anchor('sala', 'La sala') ?></li>
              <li class="man-nav-option"><?php echo anchor(lang('url_contacto'), lang('contacto')) ?></li>                                </ul>
                            </nav>
                            <div class="clear"></div>
                        </div>
                </div>    
                ...
                <div class="grid-container">
                    <div class="grid-100">
                        <div class="grid-100 grid-parent">
                            ...
                            <?php } ?>
                            <div class="separator-40"></div>
                            <h2 align="center"><?php echo $espectaculo_data['cid_titulo']; ?></h2>
          ...
          <div class="grid-container">
                   ...
                   <div class="grid-100">
                        <div class="separator-20"></div>
                              <h3><?php echo lang('imagenes'); ?></h3>
                                <?php 
                                $i = 0;
                                foreach ($espectaculo_imagenes_data as $row) { 					
                                    if($i==0) {
                                ?>
                                <div class="grid-100 grid-parent">
...
</div><?php if(!empty($espectaculo_videos_data)) { ?>
<div class="grid-100 grid-parent">
 ...
 <div class="grid-100 grid-parent">
                                    ...
                                    ?>
  <div class="grid-50">
                                            <a title="Ver video" href="javascript:void(0);" onclick="window.open('<?php echo parse_video($row['cvi_video']); ?>',  'popup', 'top=350, left=480, width=400, height=300, toolbar=NO, resizable=NO, Location=NO, Menubar=NO,  Titlebar=No, Status=NO')"><img src="/resources/uploads/contenido/<?php echo $row['cvi_thumnail']; ?>" class="thumbnail" title="Ver video" /></a
  </div>
                                    <?php
                                        if($i==2) {
                                    ?>
