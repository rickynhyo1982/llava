    ...
    <div class="grid-container">
        ...
        <div id="main-footer" class="grid-100 grid-parent">
            <div class="grid-100 grid-parent">
                <div class="separator-40">ggggg</div>
                <div class="grid-50 grid-parent">
                    <div class="grid-50">
                    <h2>footer</h2>
                        <h3><?php echo lang('datos_de_contacto'); ?>hhhhh</h3>
                        <p>
                    ...
                    <div class="grid-50">
                        ...
                        ggggg</div>
                        <p class="text-align-right">ggggg<br>
                          <a target="google-maps" href="https://maps.google.es/maps?f=q&amp;source=embed&amp;hl=es&amp;geocode=&amp;q=Escuela+de+Circo+Charivari,+Calle+Fray+Ceferino+Gonz%C3%A1lez,+Madrid&amp;aq=0&amp;oq=escuela+de+circo+ch&amp;sll=40.408513,-3.706706&amp;sspn=0.009624,0.01929&amp;t=h&amp;g=Calle+Fray+Ceferino+Gonz%C3%A1lez,+13&amp;ie=UTF8&amp;hq=Escuela+de+Circo+Charivari,&amp;hnear=Calle+Fray+Ceferino+Gonz%C3%A1lez,+28005+Madrid&amp;ll=40.408513,-3.706706&amp;spn=0.005719,0.00912&amp;z=16&amp;iwloc=A" class="blue-link">Ver mapa más grande</a></p>
                    </div>
                </div>
                <div class="grid-50">
            ...
            <div class="grid-100">
                <hr/>
                <p class="text-align-right"><small>&copy; <?php echo lang('); ?> <a href="" target="_blank"></a> <?php echo lang('fecha_desarrollo'); ?></small>ggggg</p>
            </div>
        </div>
    </div>
</footer>